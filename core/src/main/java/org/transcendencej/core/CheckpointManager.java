 ...
 * {@link org.transcendencej.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with transcendencej */
    ...
    /** Returns a checkpoints stream pointing to inside the transcendencej JAR */
