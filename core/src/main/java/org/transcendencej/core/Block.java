...
import static org.transcendencej.core.Sha256Hash.*;
...
public class Block extends Message {
     ...
     *
     * <p>The half-life is controlled by {@link org.transcendencej.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
        ...
        try {
            ...
            if (isZerocoin() && length >= ZEROCOIN_HEADER_SIZE) {
               ...
               // System.out.println("zerocoin hash parsed: "+hash.toString());
                ...
                hash = Sha256Hash.wrapReversed(XevanDigest(payload, offset, cursor - offset));
     ...
     * {@link org.transcendencej.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
