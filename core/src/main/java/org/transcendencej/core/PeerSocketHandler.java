...
import org.transcendencej.net.AbstractTimeoutHandler;
import org.transcendencej.net.MessageWriteTarget;
 ...
 * {@link org.transcendencej.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link org.transcendencej.net.NioClient} or
     * {@link org.transcendencej.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
