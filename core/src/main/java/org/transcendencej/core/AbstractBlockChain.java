 ...
 * the lightweight SPV mode, a {@link org.transcendencej.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.transcendencej.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
