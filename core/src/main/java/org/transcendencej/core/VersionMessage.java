...
public class VersionMessage extends Message {
    ...
    public static final String BITCOINJ_VERSION = "0.14.3-12.2";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for transcendencej
     * users might look like "/transcendencej:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/transcendencej:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
