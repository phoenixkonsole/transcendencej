...
import org.transcendencej.net.discovery.HttpDiscovery;
...
import org.transcendencej.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.send.regtest";
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.transcendencej.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.transcendencej.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.transcendencej.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.transcendencej.core.AlertMessage}s. You can use {@link org.transcendencej.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
