...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link org.transcendencej.crypto.MnemonicCode} for more
     ...
     *
     * @throws org.transcendencej.crypto.MnemonicException if check fails
     */
