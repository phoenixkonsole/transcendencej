...
import org.transcendencej.wallet.KeyChain.KeyPurpose;
import org.transcendencej.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.transcendencej.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.transcendencej.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
