...
/**
 * <p>A KeyChainGroup is used by the {@link org.transcendencej.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.transcendencej.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.transcendencej.crypto.KeyCrypterScrypt}.
     *
     * @throws org.transcendencej.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
