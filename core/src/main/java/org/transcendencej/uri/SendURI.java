...
import org.transcendencej.params.AbstractBitcoinNetParams;
...
public class SendURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.transcendencej.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.transcendencej.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new SendURI from the given string. Can be for any network.
     *
     ...
     */
    public SendURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public SendURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("SendURI[");
        boolean first = true;
