...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV transcendencej app. Instantiate it with a directory
 ...
 * It is to make it easier to fit transcendencej into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing transcendencej
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.transcendencej.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the transcendencej website for further details.
     */
