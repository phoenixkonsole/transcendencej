...
package org.transcendencej.tools;
...
import org.transcendencej.protocols.payments.PaymentProtocol;
import org.transcendencej.protocols.payments.PaymentProtocolException;
import org.transcendencej.protocols.payments.PaymentSession;
import org.transcendencej.script.ScriptBuilder;
import org.transcendencej.store.*;
import org.transcendencej.uri.SendURI;
import org.transcendencej.uri.BitcoinURIParseException;
import org.transcendencej.utils.BriefLogFormatter;
import org.transcendencej.wallet.DeterministicSeed;
import org.transcendencej.wallet.DeterministicUpgradeRequiredException;
import org.transcendencej.wallet.DeterministicUpgradeRequiresPassword;
...
import org.transcendencej.core.listeners.BlocksDownloadedEventListener;
...
import static org.transcendencej.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    SendURI paymentRequestURI = new SendURI(location);
